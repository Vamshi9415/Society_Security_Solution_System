...
public class VisitorExitServlet extends HttpServlet {
    @Override
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
       ...
       // String checkInTime = request.getParameter("checkInTime");
        ...
        try{
            ...
            String enterQuery = "insert into VisitorEntry(checkOutTime) values (?) where securityCode=?";
            ...
            enterPreparedStatement.setString(1,checkOutTime);
            enterPreparedStatement.setString(2,SecurityCodeEntered);
            if(resultSet.next()){
